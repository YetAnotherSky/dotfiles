...
# this is an opensuse version btw , i would also make their own dotfiles soon
...
def inst():
    ...
    sb.run(["sudo", "zypper", "install", "-y", *Packages], check=True)
...
def copy_configs():
    ...
    for folder in ["i3", "ghostty", "polybar", "rofi", "zathura", "picom", "fastfetch", "starship.toml", "cava", "fish", "tmux", "btop", "dunst"]:
